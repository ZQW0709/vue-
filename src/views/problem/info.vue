<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" stripe border style="width: 100%">
      <el-table-column prop="examtypename" label="题目类型" align="center"></el-table-column>
      <el-table-column prop="name" label="题目名称" align="center"></el-table-column>
      <el-table-column prop="a" label="选项A" align="center"></el-table-column>
      <el-table-column prop="b" label="选项B" align="center"></el-table-column>
      <el-table-column prop="c" label="选项C" align="center"></el-table-column>
      <el-table-column prop="d" label="选项D" align="center"></el-table-column>
      <el-table-column prop="correctanswer" label="答案" align="center"></el-table-column>
      <el-table-column prop="explaininfo" label="解释说明" align="center"></el-table-column>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" center width="500px">
        ...
        <el-form-item label="答案">
          <div>
            <el-checkbox-group v-model="form.correctanswer">
              <el-checkbox-button v-for="answer in answers" :label="answer" :key="answer">{{answer}}</el-checkbox-button>
            </el-checkbox-group>
          </div>
        </el-form-item>
  ...
  methods: {
    handleDownload() {
      import("@/vendor/Export2Excel").then(excel => {
        const tHeader = ["题目类型ID", "题目名称", "选项A", "选项B", "选项C","选项D","答案","解释说明"];
